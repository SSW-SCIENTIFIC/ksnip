...
if [[ -z "${GITHUB_TAG}" ]]; then
    ...
    git clone --depth 1 https://github.com/SSW-SCIENTIFIC/kImageAnnotator.git
else
    ...
    git clone --depth 1 --branch "v${KIMAGEANNOTATOR_VERSION}" https://github.com/SSW-SCIENTIFIC/kImageAnnotator.git
fi
